...
export default async function SiteSettingsAppearance({
  ...
  return (
    <div className="flex flex-col space-y-6">
      ...
      <Form
        title="Logo"
        description="The logo for your project. Accepted formats: .png, .jpg, .jpeg"
      ...
      <Form
        title="Font"
        description="The font for the heading text your project."
      ...
      <Form
        ...
        inputAttrs={{
          ...
          placeholder: "Yikes! You've found a page that doesn't exist.",
          maxLength: 240,
        }}
        handleSubmit={updateProject}
      />
