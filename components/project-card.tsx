...
import { Project as PrismaProject, ModernModel } from "@prisma/client";
import { BarChart, ExternalLink } from "lucide-react";
import Link from "next/link";

interface ProjectWithModel extends PrismaProject {
    model: ModernModel | null;
  }

export default function ProjectCard({ data }: { data: ProjectWithModel }) {
